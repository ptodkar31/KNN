# -*- coding: utf-8 -*-
"""
Created on Thu Feb 22 21:01:58 2024
...
Glass production still faces the challeges of finding optimum contents
for reducing atmospheric emmission.
Identifying ,reducing and replacing the hazardous substances in the purchased
material that end up with end product.
Are there any constraints?
Issue of climate change and energy consumtions are the major constraints
